...
#                 'Max Daily Credit': 3.5, 'Not Allowed Items': None, 'Daily meal': None}
...
#     actual = AllstdInfo[0]
#     expected = {'id': 2022458, 'name': 'Ahmad', 'Balance': 0.0,
#                 'Max Daily Credit': 1.0, 'Not Allowed Items': None, 'Daily meal': None}
#     assert actual == expected
